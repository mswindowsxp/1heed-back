...
public class UserRoles extends TableImpl<UserRolesRecord> {
    ...
    private static final long serialVersionUID = -558591554;
     ...
     */
    public final TableField<UserRolesRecord, String> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.USER_ROLES_PKEY);
    }
    ...
    public List<ForeignKey<UserRolesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UserRolesRecord, ?>>asList(Keys.USER_ROLES__USER_ROLES_FK_1, Keys.USER_ROLES__USER_ROLES_FK);
    }

    public Users users() {
        return new Users(this, Keys.USER_ROLES__USER_ROLES_FK_1);
    }

    public Roles roles() {
        return new Roles(this, Keys.USER_ROLES__USER_ROLES_FK);
    }
